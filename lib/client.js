...
var hostPreferences = { locale: "zh-CN", theme: "light" };
...
function ramifyHostPreferences() {
  return hostPreferences;
}
function setRamifyHostPreferences(next) {
  if (hostPreferences.locale === next.locale && hostPreferences.theme === next.theme) return;
  hostPreferences = next;
  for (const listener of listeners) listener();
}

// src/client/RamifyBrandMark.tsx
var import_jsx_runtime = require("react/jsx-runtime");
function RamifyBrandMark({ size = 20 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "ramify-brand-mark", width: size, height: size, viewBox: "0 0 20 20", fill: "none", "aria-hidden": "true", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "3", cy: "3", r: "1.7", fill: "#d95b57" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "17", cy: "5", r: "1.7", fill: "#d95b57" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "5", cy: "8.5", r: "1.5", fill: "#eec16f" })
  ] });
}
...
function RamifySidebarAction({ wide }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RamifyBrandMark, { size: 20 }),
        wide ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ramify-entry__label", children: "Ramify" }) : null
      ]
    }
  );
}
function ExternalIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M9.5 2.5h4v4M13.2 2.8 7.5 8.5", stroke: "currentColor", strokeWidth: "1.35", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M12 8.7v3.1c0 .94-.76 1.7-1.7 1.7H4.2c-.94 0-1.7-.76-1.7-1.7V5.7c0-.94.76-1.7 1.7-1.7h3.1", stroke: "currentColor", strokeWidth: "1.35", strokeLinecap: "round" })
  ] });
}
function CloseIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "m3.5 3.5 9 9m0-9-9 9", stroke: "currentColor", strokeWidth: "1.45", strokeLinecap: "round" }) });
}
function RamifyWorkspaceOverlay() {
  ...
  const preferences = (0, import_react.useSyncExternalStore)(subscribeRamifyWorkspace, ramifyHostPreferences, ramifyHostPreferences);
  ...
  (0, import_react.useEffect)(() => {
    if (!open2) return;
    sendPreferences();
  }, [open2, preferences.locale, preferences.theme]);
  (0, import_react.useEffect)(() => {
    if (!open2) return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "ramify-layer", role: "dialog", "aria-modal": "true", "aria-labelledby": "ramify-workspace-title", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "ramify-shell", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("header", { className: "ramify-bar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "ramify-brand", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ramify-brand__seal", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RamifyBrandMark, { size: 18 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { className: "ramify-brand__name", id: "ramify-workspace-title", children: "Ramify" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ramify-brand__meta", children: "creative branching workspace" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "ramify-status", "aria-live": "polite", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ramify-status__dot" }),
        preferences.locale === "en" ? ready ? "Workspace connected" : "Waking workspace" : ready ? "\u5DE5\u4F5C\u53F0\u5DF2\u8FDE\u63A5" : "\u6B63\u5728\u5524\u9192\u5DE5\u4F5C\u53F0"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "ramify-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { className: "ramify-icon-button", href: RAMIFY_URL, target: "_blank", rel: "noreferrer", "aria-label": "\u5728\u65B0\u7A97\u53E3\u6253\u5F00 Ramify", title: "\u5728\u65B0\u7A97\u53E3\u6253\u5F00", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ExternalIcon, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: "ramify-icon-button", type: "button", "aria-label": "\u5173\u95ED Ramify", title: "\u5173\u95ED (Esc)", onClick: () => {
          setRamifyWorkspaceOpen(false);
        }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CloseIcon, {}) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "ramify-stage", children: [
      !ready ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "ramify-loading", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "ramify-loading__sprout", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RamifyBrandMark, { size: 30 }) }),
        preferences.locale === "en" ? "Growing branches" : "\u679D\u53F6\u6B63\u5728\u5C55\u5F00"
      ] }) }) : null,
...
function RamifyProjectToolCard({ block }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "ramify-tool", "data-state": failed ? "error" : settled ? "done" : "running", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "ramify-tool__seal", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RamifyBrandMark, { size: 20 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "ramify-tool__copy", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: failed ? "Ramify \u9879\u76EE\u521B\u5EFA\u5931\u8D25" : settled ? "Ramify \u9879\u76EE\u5DF2\u5C31\u7EEA" : "\u6B63\u5728\u521B\u5EFA Ramify \u9879\u76EE" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("small", { children: failed ? "\u5C55\u5F00\u8F68\u8FF9\u67E5\u770B\u9519\u8BEF" : settled ? "\u9879\u76EE\u5DF2\u540C\u6B65\u5230\u5185\u7F6E\u5DE5\u4F5C\u53F0" : "\u6B63\u5728\u51C6\u5907\u6839\u8282\u70B9\u4E0E\u753B\u5E03" })
    ] }),
    ...
    !settled ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "ramify-tool__sweep", "aria-hidden": "true" }) : null
  ] });
}
